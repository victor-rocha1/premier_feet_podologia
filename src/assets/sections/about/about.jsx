        ...
        <>
            <div className="about">
                <div className="title-clinica">
                    <h2>PREMIER FEET CARE PODOLOGIA</h2>
            ...
            <div className="about-container">
                <div className="txt_about">
                    ...
                    <p>
                        Desde maio de 2023, a Premier Feet Care Podologia tem sido referência em saúde e bem-estar para os pés. Fundada com o propósito de oferecer um atendimento humanizado e altamente especializado, nossa clínica é liderada por uma podóloga experiente e apaixonada pelo que faz.
                    </p>
                    <p>
